                ...
                steps{
                    script{
                       ...
                       def liquibaseCommand = """
                        liquibase \
                              --url="jdbc:snowflake://emeadev01.eu-west-1.privatelink.snowflakecomputing.com/?user=CMMFRCRO@pfizer.com&private_Key_File=/home/srvamr-sfaops/test_private_key/test.p8&private_Key_File_Pwd=${private_key_password}&warehouse=PFE_COMMON_WH_XS_01&db=COMETL_SFDC_X_REGION_DEV_DB&schema=COMETL_SFDC_PUBLISH" \
